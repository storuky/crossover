...
.value('taTranslations', {
  ...
  justifyCenter: {
	...
	indent: {
	    ...
	    clear: {
	        tooltip: 'Отчистить форматирование'
	    },
	    insertImage: {
	        dialogPrompt: 'Вставьте url картинки',
	        tooltip: 'Вставка изображения',
	        hotkey: ''
	    },
	    insertVideo: {
	        tooltip: 'Вставка видео',
	        dialogPrompt: 'Вставьте embed-ссылку на youtube-ролик'
	    },
	    insertLink: {
	        tooltip: 'Вставить / Изменить ссылку',
	        dialogPrompt: "Укажите ссылку"
	    },
	    editLink: {
	        reLinkButton: {
	            tooltip: "Перелинковать"
	        },
	        unLinkButton: {
	            tooltip: "Убрать ссылку"
	        },
	        targetToggle: {
	            buttontext: "Открыть в новом окне"
	        }
	    },
	    wordcount: {
	        tooltip: 'Количество слов'
	    },
	        charcount: {
	        tooltip: 'Количество символов'
	    }
})
