                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            var closeTemplate = options.showClose ? '<div class="ngdialog-close"></div>' : '';

                            var hasOverlayClass = options.overlay ? '' : ' ngdialog-no-overlay';
                            $dialog = $el('<div id="'+dialogID + '" class="ngdialog' + hasOverlayClass + '"></div>');
                            $dialog.html((options.overlay ?
                                                            '<div class="ngdialog-overlay"><div class="ngdialog-content" role="document">' + closeTemplate + template + '</div></div>' :
                            ...
                            if (options.before_controller && options.before_controller().then){
                                options.before_controller().then(function () {
                                    init_controller();
                                });
                            } else {
                                init_controller();
            ...
            link: function (scope, elem, attrs) {
                elem.on('click', function (e) {
                    ...
                    ngDialog.open({
                        ...
                        before_controller: attrs.ngDialogBeforeController,
